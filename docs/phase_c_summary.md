...
What's still deferred for Phase C: **C8 folder bookmarks**; **C9 persistent banner above OutputStatusBar** (today the relink path is reachable only via Pre-Show); **C10/C11 thumbnails**; **C12-C15 audio**. **C16 Phase C summary + manual rehearsal steps** is the wrap-up.
