...
struct SlideSettings: Codable, Hashable {
    ...
    var brightness: Double = 0     // -100 (darker) ... +100 (brighter), 0 = unchanged
    var contrast: Double = 100     // percent, 0 = flat, 100 = unchanged, 200 = doubled
    ...
    init(from decoder: Decoder) throws {
        ...
        contrast = try container.decodeIfPresent(Double.self, forKey: .contrast) ?? 100
